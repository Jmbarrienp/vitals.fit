...
const expo_push_service_1 = require("./services/expo-push.service");
...
exports.PushModule = PushModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [device_token_service_1.DeviceTokenService, expo_push_service_1.ExpoPushService],
        exports: [expo_push_service_1.ExpoPushService],
    })
], PushModule);
