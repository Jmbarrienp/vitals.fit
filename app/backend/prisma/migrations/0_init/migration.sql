...
CREATE TABLE "AiGenerationLog" (
    ...
    "inputTokenApprox" INTEGER,
    "outputTokens" INTEGER,
    "cacheHit" BOOLEAN NOT NULL DEFAULT false,
    "compactSnapshot" JSONB,
...
-- CreateIndex
CREATE INDEX "PushLog_status_createdAt_idx" ON "PushLog"("status", "createdAt");
...
-- CreateIndex
CREATE INDEX "AiGenerationLog_trigger_createdAt_idx" ON "AiGenerationLog"("trigger", "createdAt");
